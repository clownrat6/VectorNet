...
https://zhuanlan.zhihu.com/p/35138077

To be continued

### 4. 你用过什么无监督的模型？

答的是 W-Net [[9]](#ref9) 大概老师也没太懂吧，其实应该慢点答的，在情感识别项目中就使用自编码器来提取图像自编码特征来更高效地进行情感建模，面试还是太慌张了一点，没有很好地表达自己的意思，除了自编码器还有聚类算法，主成分分析算法，例如，YOLO 计算先验 Anchor 时就有使用聚类算法，在医学数据分析的时候分析肿瘤诱发源的时候也使用过主成分分析算法。
